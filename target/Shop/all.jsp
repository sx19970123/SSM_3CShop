...
<!DOCTYPE html>
<!-- saved from url=(0048)http://www.aifou.cn/category/list/pve/8/p/1.html -->
<html lang="zh-cn">
...
<section class="m-plist w">
    <aside class="aside m-pmodel J_superSide" data-settings="{
            &quot;header&quot;:&quot;header&quot;,
            &quot;headergap&quot;:60,
            &quot;footer&quot;:&quot;.m-footer&quot;,
            &quot;footergap&quot;:100,
        ...
        <c:forEach items="${brands}" var="brand">
            <dl class="">
                <dt><a href="Brand_Commodity?commodity_category_id=${brand.category_id}&&brand_id=${brand.brand_id}"><i
                        class="i-icon"></i><span>${brand.brand_name}</span></a></dt>
            </dl>
        </c:forEach>
    </aside>
    ...
    <article class="main">
        ...
        <ul class="m-product-list c x06 xs020 m04 l03">

            <c:forEach items="${commodities}" var="all">
                <li class="g">
                    <a href="COMMODITY_Detailed?commodity_id=${all.commodity_id}&&pj=2" target="_blank">
                        <p class="thumb">
                            <img src="${all.commodity_photo1}">
                        </p>
                        <p class="title" align="center">${all.commodity_brand}${all.commodity_name}</p>
                        <em class="price">¥${all.commodity_price}</em>
                    </a>
                </li>
            </c:forEach>
        </ul>
